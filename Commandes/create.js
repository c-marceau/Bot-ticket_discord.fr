...
module.exports.run = async (bot, message, args) => {
  ...
  .setColor('#e64b0e')
  .setDescription(`Erreur. Donnez-moi l'autorisation: gérer les chaînes`)
  ...
  if (daily !== null && timeout - (Date.now() - daily) > 0) {
    ...
    .setColor("#e64b0e")
    .setDescription(`Vous avez un temps de recharge de ${time.minutes}m ${time.seconds}s jusqu'à ce que vous puissiez ouvrir un autre ticket`);
  ...
  .setDescription(`\n\nHello ${message.author},\n\nMerci d'avoir fait un ticket. L'équipe de support vous aidera dès que possible.\n\n**Ticket Catergory:** ${topic1}`)
  ...
  .setColor('#e64b0e')
  .setDescription(`Ticket Annulé`)

  let timeoutembed = new Discord.RichEmbed()
  .setColor('#e64b0e')
  .setDescription(`Temps ecpirer`)

  let input = new Discord.RichEmbed()
  .setColor('#e64b0e')
  .setDescription(`Veuillez choisir parmi l'un des sujets de ticket suivants : \n\n1: ${topic1}\n2: ${topic2}\n3: ${topic3}\n4: ${topic4}\n5: ${topic5}`)
  .setFooter(`Cela expirera dans 10 secondes, puis vous serez mis sur un temps de recharge de 5 minutes`)

  let logchannelembed1 = new Discord.RichEmbed()
  .setColor('#52d411')
  .setTitle(`Ticket Créer`)
  .setDescription(`Ouvert par : ${message.author}\nTicket Numéro : \`${ticketcount}\`\nTicket Raison : \`${topic1}\``)

  let logchannelembed2 = new Discord.RichEmbed()
  .setColor('#52d411')
  .setTitle(`Ticket Créer`)
  .setDescription(`Ouvert par : ${message.author}\nTicket Numéro : \`${ticketcount}\`\nTicket Raison : \`${topic2}\``)

  let logchannelembed3 = new Discord.RichEmbed()
  .setColor('#52d411')
  .setTitle(`Ticket Créer`)
  .setDescription(`Ouvert par : ${message.author}\nTicket Numéro : \`${ticketcount}\`\nTicket Raison : \`${topic3}\``)

  let logchannelembed4 = new Discord.RichEmbed()
  .setColor('#52d411')
  .setTitle(`Ticket Créer`)
  .setDescription(`Ouvert par : ${message.author}\nTicket Numéro : \`${ticketcount}\`\nTicket Raison : \`${topic4}\``)

  let logchannelembed5 = new Discord.RichEmbed()
  .setColor('#52d411')
  .setTitle(`Ticket Créer`)
  .setDescription(`Ouvert par : ${message.author}\nTicket Numéro : \`${ticketcount}\`\nTicket Raison : \`${topic5}\``)
  ...
  msg.awaitReactions(filter, {
    ...
    message.guild.createChannel(name, { type: "text" }).then(
      ...
      .setColor('#e64b0e')
      .setDescription(`Ticket Créer, #${chan.name}`)
